 ...
 * @param {React.Component} root0.component the component which needed to be loaded with Suspense
 * @param {React.Component} root0.fallback the fallback component while the component is being loaded
 * @returns {React.Component} returns the suspended component
